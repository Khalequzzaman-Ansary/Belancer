        ...
        <nav className="bg-white shadow-md p-3">
            <div className="w-full max-w-screen-xl mx-auto flex justify-between items-center px-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative hidden md:block">
                        <input
                            ...
                            className="px-4 py-2 border rounded-full w-96 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        />
                        <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-black text-white p-2 rounded-full">
                            <FaSearch />
                        </button>
                    </div>
                </div>
                ...
                <div className="hidden md:flex items-center gap-6">
                    ...
                    <Link to="#" className="border border-green-500 text-green-500 px-4 py-2 rounded-full hover:bg-green-500 hover:text-white">
                        Join
                    </Link>
                </div>
